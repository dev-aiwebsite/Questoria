          ...
          >
            ...
            <div className="flex flex-row flex-nowrap items-center justify-center gap-2">
              {[1, 2, 3, 4, 5].map((starIndex) => (
                ...
                >
                  <Star
                    className={`h-[50px] stroke-black w-auto aspect-square transition-colors duration-200 ${starIndex <= rating
      ...
      <div className="p-mobile bg-primary height-with-nav overflow-auto">
        <div className="gap-4 text-center flex flex-col flex-nowrap justify-center h-full min-h-fit">
          ...
          <div className="flex flex-row flex-nowrap gap-3 items-center justify-center">
            <a  href="https://www.linkedin.com/company/questoria-australia/" target="_blank">
              <div className="w-14 h-14 social linkedin"></div>
            </a>
            <a className="cursor-pointer" href="https://www.facebook.com/profile.php?id=61584686996517" target="_blank">
              <div className="w-14 h-14 social fb"></div>

            </a>
            <a className="cursor-pointer" href="https://www.instagram.com/questoriago" target="_blank">
              <div className="w-14 h-14 social insta"></div>
            </a>
            <a className="cursor-pointer" href="https://www.tiktok.com/@questoriago" target="_blank"
            >
